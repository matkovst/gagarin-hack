...
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/anomaly/1.mp4 > data/Test/anomaly/1.ffprobe
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/anomaly/2.mp4 > data/Test/anomaly/2.ffprobe
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/anomaly/3.mp4 > data/Test/anomaly/3.ffprobe
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/anomaly/4.mp4 > data/Test/anomaly/4.ffprobe
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/anomaly/5.mp4 > data/Test/anomaly/5.ffprobe
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/anomaly/6.mp4 > data/Test/anomaly/6.ffprobe
...
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/not_anomaly/1.mp4 > data/Test/not_anomaly/1.ffprobe
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/not_anomaly/2.mp4 > data/Test/not_anomaly/2.ffprobe
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/not_anomaly/3.mp4 > data/Test/not_anomaly/3.ffprobe
ffprobe -v quiet -show_entries frame=pkt_size,pkt_pts_time,key_frame data/Test/not_anomaly/4.mp4 > data/Test/not_anomaly/4.ffprobe
